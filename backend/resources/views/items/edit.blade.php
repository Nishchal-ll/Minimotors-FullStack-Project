                ...
                <div class="max-w-3xl mx-auto">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                            ...
                            <!-- Name -->
                            <div class="mb-6">
                                <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Item Name <span class="text-red-500">*</span></label>
                                <input type="text" id="name" name="name" required
                                    class="w-full pl-4 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-400"
                                    placeholder="Enter item name (e.g., PowerMax Pro Motor)">
                            </div>

                            <!-- Price -->
                            <div class="mb-6">
                                <label for="price" class="block text-sm font-semibold text-gray-700 mb-2">Price (Nrs) <span class="text-red-500">*</span></label>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="w-full pl-4 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-400"
                                    placeholder="Write a short description about the item..."></textarea>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition">
                                    ...
                                    <label for="image" class="cursor-pointer bg-white border-2 border-blue-500 text-blue-600 hover:bg-blue-50 font-semibold px-6 py-2 rounded-lg transition">
                                        Choose File
                                    </label>
                                    <p class="text-sm text-gray-500 mt-3" id="file-name">No file chosen</p>
                                </div>
                            ...
                            <div class="flex items-center space-x-4">
                                <button type="submit"
                                    class="flex-1 bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 text-white font-bold py-4 px-6 rounded-xl shadow-lg transform hover:scale-105 transition">
                                    Save Item
                                </button>
                                <a href="{{ route('dashboard') }}"
                                    class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-4 px-6 rounded-xl border-2 border-gray-300 transition flex items-center justify-center">
                                    Cancel
                                </a>
                            </div>
                        </form>
